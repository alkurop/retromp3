...
import com.omar.retromp3recorder.bl.billing.ListAvailableProductsUC
...
class HomeViewInteractor @Inject constructor(
    ...
    private val listAvailableProductsUC: ListAvailableProductsUC,
    ...
    override fun listRepos(): List<Flow<HomeViewContract.Output>> {
        return listOf(
            flow {
                val result = listAvailableProductsUC.execute()
                println(result)
            },
